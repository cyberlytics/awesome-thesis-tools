...
- Adobe **Acrobat** Pro
	...
	- Web:
		...
		- Toolbox: [iLovePDF](https://www.ilovepdf.com/), [PDF24 Tools](https://tools.pdf24.org/), [Smallpdf](https://smallpdf.com/pdf-tools), [pdfforge Online](https://www.pdfforge.org/online/), or [A Box of Tools](https://abox.tools/de/) (Open Source, verarbeitet die Datei lokal im Browser – nichts wird hochgeladen)
